...
BANDO_APP_ConnHandleNotEvt_t BANDOHandleNotification;

static char a_GapDeviceName[] = {  'B', 'a', 'n', 'd', 'o', 'n', 'e', 'o' }; /* Gap Device Name */

/* Advertising Data */
uint8_t a_AdvData[11] =
{
  5, AD_TYPE_COMPLETE_LOCAL_NAME, 'b', 'n', 'e', 'o',  /* Complete name */
  4, AD_TYPE_MANUFACTURER_SPECIFIC_DATA, 0x30, 0x00, 0x12 /*  */,
};
...
SVCCTL_UserEvtFlowStatus_t SVCCTL_App_Notification(void *p_Pckt)
{
  ...
  switch (p_event_pckt->evt)
  {
    case HCI_DISCONNECTION_COMPLETE_EVT_CODE:
    {
      ...
      BANDOHandleNotification.EvtOpcode = BANDO_DISCON_HANDLE_EVT;
      BANDOHandleNotification.ConnectionHandle = p_disconnection_complete_event->Connection_Handle;
      BANDO_APP_EvtRx(&BANDOHandleNotification);
    ...
    case HCI_LE_META_EVT_CODE:
    {
      ...
      switch (p_meta_evt->subevent)
      {
        ...
        case HCI_LE_ENHANCED_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          BANDOHandleNotification.EvtOpcode = BANDO_CONN_HANDLE_EVT;
          BANDOHandleNotification.ConnectionHandle = p_enhanced_conn_complete->Connection_Handle;
          BANDO_APP_EvtRx(&BANDOHandleNotification);
        ...
        case HCI_LE_CONNECTION_COMPLETE_SUBEVT_CODE:
        {
          ...
          BANDOHandleNotification.EvtOpcode = BANDO_CONN_HANDLE_EVT;
          BANDOHandleNotification.ConnectionHandle = p_conn_complete->Connection_Handle;
          BANDO_APP_EvtRx(&BANDOHandleNotification);
